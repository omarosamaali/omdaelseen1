...
<div class="py-4 text-end" style="margin-top: 30px;">
    <div style="">
        <div style="display: flex; flex-direction: row-reverse; justify-content: space-between;">
            <a href="{{ route('admin.about.create') }}" class="" style="background: black; color: white; padding: 10px 20px; border-radius: 5px; margin: 15px 0px; margin-left: 20px;">إضافة
                من نحن</a>
        ...
        <div class="relative overflow-x-auto shadow-md sm:rounded-lg" style="max-width: 100%; margin: 20px">
            <table id="works_table" class="w-full text-sm text-left rtl:text-right text-gray-500" style="background: #c9c9c9;">
                ...
                <tbody>
                    ...
                    <tr class="odd:bg-white even:bg-gray-50 border-b border-gray-200">
                        ...
                        <td class="th">
                            @if ($work->avatar)
                            <img style="width: 40px; height: 40px; border-radius: 13px;" src="{{ asset('storage/' . $work->avatar) }}" alt="Work Image">
                            @else
                            لا يوجد صورة
                            @endif
                        </td>
                        ...
                        <td class="th" style="display: flex;">
                            ...
                            <a href="{{ route('admin.about.edit', $work->id) }}" class="font-medium text-blue-600">
                            ...
                            <form action="{{ route('admin.about.destroy', $work->id) }}" onclick="return confirm('هل أنت متأكد من حذف هذا؟')" method="POST" class="inline-block">
                                @csrf
                                @method('DELETE')
