    ...
    <div class="py-4 text-end" style="margin-top: 30px;">
        <div>
            <div style="display: flex; flex-direction: row-reverse; justify-content: space-between;">
                <a href="{{ route('admin.omdaHome.adds.create') }}" class=""
                ...
                <div
                    ...
                    <div class="custom-select" style="position: relative; width: fit-content;">
                        <div style="position: relative;">
                            ...
                            <input aria-autocomplete="off" autocomplete="off" type="text" id="faq_search"
                                name="faq_search"
                ...
                <table id="faqs_table" class="w-full text-sm text-left rtl:text-right text-gray-500"
                    ...
                    <thead class="text-xs text-gray-700 uppercase">
                        <tr>
                            ...
                            <th scope="col" class="th">الإضافة</th>
                            <th scope="col" class="th">المبلغ</th>
                            <th scope="col" class="th">مرات الاستخدام</th>
                    ...
                    <tbody>
                        @foreach ($adds as $add)
                            <tr class="odd:bg-white even:bg-gray-50 border-b border-gray-200">
                                ...
                                @php $counter++; @endphp
                                <td class="th">{{ Str::limit($add->type_ar, 30) }}</td>
                                <td class="th">{{ $add->price }}</td>
                                <td class="th">32</td>
                                <td class="th">
                                ...
                                <td class="th" style="display: flex;">
                                    <a href="{{ route('admin.omdaHome.adds.show', $add->id) }}"
                                    ...
                                    <a href="{{ route('admin.omdaHome.adds.edit', $add->id) }}"
                                    ...
                                    <form action="{{ route('admin.omdaHome.adds.destroy', $add->id) }}"
