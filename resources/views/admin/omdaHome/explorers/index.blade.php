    ...
    <div class="py-4 text-end" style="margin-top: 30px;">
        ...
        <div style="">
            ...
            <div style="display: flex; flex-direction: row-reverse; justify-content: space-between;">
                ...
                <a href="{{ route('admin.explorers.create') }}" class=""
            ...
            <div class="relative overflow-x-auto shadow-md sm:rounded-lg" style="max-width: 100%; margin: 20px">
                <table id="explorers_table" class="w-full text-sm text-left rtl:text-right text-gray-500" style="
                        background: #c9c9c9;">
                    ...
                    <tbody>
                        @foreach ($explorers as $explorer)
                            <tr class="odd:bg-white even:bg-gray-50  border-b  border-gray-200">
                                ...
                                <td class="th">
                                    {{-- {{ $explorer->avatar }} --}}
                                    <img style="width: 40px; height: 40px; border-radius: 13px;" src="{{ asset('storage/' . $explorer->avatar) }}" alt="{{ $explorer->name_ar }}">
                                </td>
                                ...
                                <td class="th" style="display: flex; ">
                                    ...
                                    <a href="{{ route('admin.explorers.edit', $explorer->id) }}" class="font-medium text-blue-600">
                                    ...
                                    <form action="{{ route('admin.explorers.destroy', $explorer->id) }}"
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                ...
                const table = document.getElementById('explorers_table');
