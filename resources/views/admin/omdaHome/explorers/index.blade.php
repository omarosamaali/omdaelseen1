...
<div class="py-4 text-end" style="margin-top: 30px;">
    <div>
        <div style="display: flex; flex-direction: row-reverse; justify-content: space-between;">
            <a href="{{ route('admin.explorers.create') }}" class="" style="background: black; color: white;
                    ...
                    <tr class="odd:bg-white even:bg-gray-50  border-b  border-gray-200">
                        ...
                        <td class="th">
                            ...
                            <img style="width: 40px; height: 40px; border-radius: 13px;"
                                src="{{ asset('storage/' . $explorer->avatar) }}" alt="{{ $explorer->name_ar }}">
                        </td>
                        ...
                        <td class="th" style="display: flex; ">
                            ...
                            <a href="{{ route('admin.explorers.edit', $explorer->id) }}"
