...
@section('content')
    <div class="py-4 text-end" style="margin-top: 30px; max-width: 800px; margin-right: auto; margin-left: auto;">
        ...
        <div class="bg-white p-6 rounded-lg shadow-md">
            <div class="mb-4">
                <label class="block text-sm font-medium text-gray-700">نوع الكلمة:</label>
                <p class="mt-1 text-gray-900">{{ $helpWord->word_type }}</p>
                </div>
            ...
            <div class="mb-4">
                ...
                <p class="mt-1 text-gray-900">
                    {{ $helpWord->word_zh }}
                    @if ($helpWord->word_zh)
                        <span class="speak-btn" data-text="{{ $helpWord->word_zh }}" title="تشغيل النطق"
                            style="cursor: pointer; margin-right: 10px;">
                            <svg class="w-5 h-5 text-blue-600 inline" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                                fill="currentColor" viewBox="0 0 24 24">
                                <path
                                    d="M13 3a1 1 0 0 1 1 1v6.586l1.707-1.707a1 1 0 0 1 1.414 1.414l-3.414 3.414a1 1 0 0 1-1.414 0L9.879 10.293a1 1 0 0 1 1.414-1.414L13 10.586V4a1 1 0 0 1 1-1z" />
                                <path
                                    d="M5 8a1 1 0 0 1 1 1v6a1 1 0 0 1-2 0V9a1 1 0 0 1 1-1zm14 0a1 1 0 0 1 1 1v6a1 1 0 0 1-2 0V9a1 1 0 0 1 1-1z" />
                            </svg>
                        </span>
                    @endif
                </p>
            ...
            <div class="mb-4">
                ...
                <p class="mt-1 text-gray-900 {{ $helpWord->status == 'نشط' ? 'text-green-600' : 'text-red-600' }}">
                    {{ $helpWord->status }}</p>
            </div>
            <div class="mb-4">
            ...
            <div class="text-center">
                <a href="{{ route('admin.help_words.edit', $helpWord->id) }}"
                    class="bg-black text-white px-4 py-2 rounded-md">تعديل</a>
