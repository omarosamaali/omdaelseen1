...
@section('content')
<h2 class="text-right mb-4 font-bold text-xl" style="display: flex; margin-top: 50px; margin-right: 50px; ">سياسة الخصوصية</h2>
<div style="display: flex; flex-direction: row-reverse; position: relative; z-index: 1;">
    <div class="container py-4 mx-auto max-w-4xl" style="margin-bottom: 50px; position: relative; right: -50px;  background: white; border-radius: 10px; padding: 20px;">
