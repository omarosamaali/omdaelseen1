                    ...
                    <tbody>
                        @foreach ($review_reports as $report)
                            <tr class="odd:bg-white even:bg-gray-50 border-b border-gray-200">
                                <td class="th">
                                    {{ is_object($report) ? $report->id : (isset($report['id']) ? $report['id'] : 'N/A') }}
                                </td>
                                <td class="th">
                                    {{ is_object($report) && isset($report->place) ? $report->place->name_ar : (isset($report['place']['name_ar']) ? $report['place']['name_ar'] : 'N/A') }}
                                </td>
                                <td class="th">
                                    {{ is_object($report) && isset($report->user) ? $report->user->name : (isset($report['user']['name']) ? $report['user']['name'] : 'N/A') }}
                                </td>
                                <td class="th">
                                    تقييم مخالف
                                </td>
                                <td class="th" style="display: flex;">
                                    <a href="{{ route('admin.reports.review_show', is_object($report) ? $report->id : (isset($report['id']) ? $report['id'] : '')) }}"
                                    ...
                                    <form
                                        action="{{ route('admin.reports.destroy', is_object($report) ? $report->id : (isset($report['id']) ? $report['id'] : '')) }}"
                        ...
                        @foreach ($reports as $report)
                            <tr class="odd:bg-white even:bg-gray-50 border-b border-gray-200">
                                ...
                                <td class="th" style="display: flex;">
                                    <a href="{{ route('admin.reports.show', is_object($report) ? $report->id : (isset($report['id']) ? $report['id'] : '')) }}"
                                        class="font-medium text-green-600">
                                        <svg class="w-6 h-6 text-green-800" aria-hidden="true"
                                            xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none"
                                            viewBox="0 0 24 24">
