...
@section('content')
<h2 class="text-right mb-4 font-bold text-xl" style="display: flex; margin-top: 50px; margin-right: 50px; ">الشروط</h2>
    ...
    <div style="display: flex; flex-direction: row-reverse; margin: 0px 20px; position: relative; z-index: 1;">
        <div class="container py-4 mx-auto max-w-4xl"
            ...
            <form action="{{ route('admin.terms.update', $work->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                    ...
                    <div class="mb-4">
                        ...
                        <div class="editor-wrapper">
                            ...
                            <div class="toolbar">
                                ...
                                <div class="toolbar-group">
                                    <button type="button" onclick="document.getElementById('fileInput_en').click()">رفع صورة</button>
                            ...
                            <div class="editor-container">
                                ...
                                <div class="editor-content" id="editor_en" contenteditable="true" data-lang="en" style="direction: rtl; text-align: right;">{!! $work->content_en ?? '' !!}</div>
                            </div>
                            <div class="status-bar">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="editor-wrapper">
                            ...
                            <div class="toolbar">
                                ...
                                <div class="toolbar-group">
                                    <button type="button" onclick="document.getElementById('fileInput_ch').click()">رفع صورة</button>
                            ...
                            <div class="editor-container">
                                ...
                                <div class="editor-content" id="editor_ch" contenteditable="true" data-lang="zh-CN" style="direction: rtl; text-align: right;">{!! $work->content_zh ?? '' !!}</div>
                            </div>
                            <div class="status-bar">
                    ...
                    <div class="mb-4">
                        ...
                        @if ($work->avatar)
                            <div class="mt-2">
                                ...
                                <img src="{{ asset('storage/' . $work->avatar) }}" alt="صورة العمل" style="width: 91px; height: 63px;" class="mt-2 object-cover rounded">
                            </div>
                        @endif
                        @error('avatar')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                ...
                <div class="flex justify-between" style="margin-top: 20px;">
                    <a href="{{ route('admin.terms.index') }}" class="px-4 py-2 bg-gray-500 text-white rounded-md hover:bg-gray-600">إلغاء</a>
