...
@section('content')
    <div class="py-4 text-end" style="margin-top: 30px; max-width: 800px; margin-right: auto; margin-left: auto;">
        <h2 class="text-right text-2xl font-bold mb-4">إضافة ميزة جديدة</h2>
        <form action="{{ route(name: 'admin.omdaHome.trip-features.store') }}" method="POST">
            @csrf
            <div class="mb-4">
                <label for="name_ar" class="block text-sm font-medium text-gray-700 text-right">الميزة (عربي)</label>
            ...
            <div class="mb-4">
                <label for="name_en" class="block text-sm font-medium text-gray-700 text-right">الميزة (إنجليزي)</label>
            ...
            <div class="mb-4">
                <label for="name_ch" class="block text-sm font-medium text-gray-700 text-right">الميزة (صيني)</label>
