    ...
    <div class="py-4 text-end" style="margin-top: 30px;">
        <div style="">
            <div style="display: flex; flex-direction: row-reverse; justify-content: space-between;">
                <a href="{{ route('admin.omdaHome.trip-features.create') }}" class=""
                ...
                <table id="faqs_table" class="w-full text-sm text-left rtl:text-right text-gray-500"
                    ...
                    <thead class="text-xs text-gray-700 uppercase">
                        <tr>
                            ...
                            <th scope="col" class="th">الميزة</th>
                    ...
                    <tbody>
                        @foreach ($guidelines as $faq)
                            <tr class="odd:bg-white even:bg-gray-50 border-b border-gray-200">
                                ...
                                @php $counter++; @endphp
                                <td class="th">{{ Str::limit($faq->name_ar, 30) }}</td>
                                ...
                                <td class="th" style="display: flex;">
                                    <a href="{{ route('admin.omdaHome.trip-features.show', $faq->id) }}"
                                    ...
                                    <a href="{{ route('admin.omdaHome.trip-features.edit', $faq->id) }}"
                                    ...
                                    <form action="{{ route('admin.omdaHome.trip-features.destroy', $faq->id) }}"
