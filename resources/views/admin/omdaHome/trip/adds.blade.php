...
@section('content')
    <div
        ...
        <div class="container py-4 mx-auto max-w-4xl"
            ...
            <h2 class="text-right mb-4 font-bold text-xl">الإضافات</h2>
            <form action="{{ route('admin.explorers.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div class="mb-4">
                        <label class="block text-sm font-medium text-gray-700">النوع بالعربي</label>
                        <input type="text" id="name_ar" name="name_ar"
                            class="input-field @error('name_ar') border-red-500 @enderror" value="{{ old('name_ar') }}"
                            required>
                        @error('name_ar')
                    ...
                    <div class="mb-4">
                        <label class="block text-sm font-medium text-gray-700">النوع بالإنجليزي</label>
                        <input type="text" id="name_en" name="name_en"
                            class="input-field @error('name_en') border-red-500 @enderror" value="{{ old('name_en') }}"
                            required>
                        @error('name_en')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                        @enderror
                    ...
                    <div class="mb-4">
                        <label class="block text-sm font-medium text-gray-700">النوع بالصيني</label>
                        <input type="text" id="name_ch" name="name_ch"
                            class="input-field @error('name_ch') border-red-500 @enderror" value="{{ old('name_ch') }}"
                            required>
                        @error('name_ch')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                        @enderror
                    ...
                    <div class="mb-4">
                        <label class="block text-sm font-medium text-gray-700">التفاصيل بالعربي</label>
                        <textarea type="text" id="name_ar" name="name_ar"
                            class="input-field @error('name_ar') border-red-500 @enderror" value="{{ old('name_ar') }}"
                            required></textarea>
                        @error('name_ar')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    ...
                    <div class="mb-4">
                        <label class="block text-sm font-medium text-gray-700">التفاصيل بالإنجليزي</label>
                        <textarea type="text" id="name_en" name="name_en"
                            class="input-field @error('name_en') border-red-500 @enderror" value="{{ old('name_en') }}"
                            required></textarea>
                        @error('name_en')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    ...
                    <div class="mb-4">
                        <label class="block text-sm font-medium text-gray-700">التفاصيل بالصيني</label>
                        <textarea type="text" id="name_ch" name="name_ch"
                            class="input-field @error('name_ch') border-red-500 @enderror" value="{{ old('name_ch') }}"
                            required></textarea>
                        @error('name_ch')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="number" id="name_en" name="name_en"
                            class="input-field @error('name_en') border-red-500 @enderror" value="{{ old('name_en') }}"
                            required>
                        @error('name_en')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
