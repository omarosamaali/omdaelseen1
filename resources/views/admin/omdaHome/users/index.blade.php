...
<div class="py-4 text-end" style="margin-top: 30px;">
    ...
    <div style="">
        ...
        <div style="display: flex; flex-direction: row-reverse; justify-content: space-between;">
            ...
            <a href="{{ route('admin.users.create') }}" class="" style="background: black; color: white;
                ...
                <div class="custom-select" style="position: relative; width: fit-content; ">
                    <div style="position: relative;">
                        <span style="position: absolute; top: 50%; transform: translateY(-50%); right: 0.75rem; color: #9ca3af; pointer-events: none;">
                            <svg style="width: 20px; color:rgb(129, 126, 126);" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
        ...
        <div style="display: flex; justify-content: space-between; max-width: 100%; margin: 30px 20px;">
            <a style="background: rgb(201, 200, 200); text-align: center; width: 130px; color: black; font-weight:bold; border-radius: 10px; padding: 20px;" href="{{ route('admin.users.index', ['filter' => 'admin', 'user_search' => request('user_search')]) }}" class="filter-box {{ $currentFilter === 'admin' ? 'active' : '' }}">
                الإدارة<br />{{ $adminsCount }}
            </a>
            <a style="background: rgb(201, 200, 200); text-align: center; width: 130px; color: black; font-weight:bold; border-radius: 10px; padding: 20px;" href="{{ route('admin.users.index', ['filter' => 'user', 'user_search' => request('user_search')]) }}" class="filter-box {{ $currentFilter === 'user' ? 'active' : '' }}">
                المستخدمين<br />{{ $usersCount }}
            </a>
            <div style="background: rgb(201, 200, 200); text-align: center; width: 130px; color: black; font-weight:bold; border-radius: 10px; padding: 20px;">
                بدون طلبات
                <br />
                123
            </div>

            <a style="background: rgb(201, 200, 200); text-align: center; width: 130px; color: black; font-weight:bold; border-radius: 10px; padding: 20px;" href="{{ route('admin.users.index', ['filter' => 'active', 'user_search' => request('user_search')]) }}" class="filter-box {{ $currentFilter === 'active' ? 'active' : '' }}">
        ...
        <div class="relative overflow-x-auto shadow-md sm:rounded-lg" style="max-width: 100%; margin: 20px">
            <table id="users_table" style="z-index: 99999; position: relative;" class="w-full text-sm text-left rtl:text-right text-gray-500" style="
    background: #c9c9c9;
">
                ...
                <tbody>
                    ...
                    <tr class="odd:bg-white even:bg-gray-50  border-b  border-gray-200">
                        <th scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap">
                            ...
                            <img style="width: 30px; height: 20px; border-radius: 0px; border: 0px;" src="https://flagcdn.com/32x24/{{ strtolower($user->country) }}.png" alt="{{ $user->country }} Flag">
                            @else
                            <img style="width: 30px; height: 20px; border-radius: 0px; border: 0px;" src="https://flagcdn.com/32x24/xx.png" alt="Default Flag">
                            @endif
                        ...
                        <td class="th" style="display: flex;">
                            <a href="{{ route('admin.users.show', $user->id) }}" class="font-medium text-green-600">
                            ...
                            <a href="{{ route('admin.users.edit', $user->id) }}" class="font-medium text-blue-600">
                            ...
                            <form action="{{ route('admin.users.destroy', $user->id) }}" onclick="return confirm('هل انت متاكد من حذف هذا المستخدم؟')" method="POST" class="inline-block">
                                @csrf
                                @method('DELETE')
            ...
            <nav style="background-color: #fff; z-index: 9999; position: relative;" class="flex flex-col md:flex-row justify-between items-start md:items-center space-y-3 md:space-y-0 p-4" aria-label="Table navigation">
