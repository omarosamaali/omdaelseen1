                ...
                <tbody>
                    ...
                    <tr class="odd:bg-white even:bg-gray-50 border-b border-gray-200">
                        ...
                        <td class="th" style="display: flex;">
                            ...
                            <a href="{{ route('admin.works.edit', $work->id) }}" class="font-medium text-blue-600">
                            ...
                            <form action="{{ route('admin.works.destroy', $work->id) }}"
                                onclick="return confirm('هل أنت متأكد من حذف هذا؟')" method="POST" class="inline-block">
                                @csrf
                                @method('DELETE')
