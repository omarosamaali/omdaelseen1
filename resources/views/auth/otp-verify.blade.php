    ...
    <div class="page-container">
       ...
       OTP&nbsp;أدخل رمز
        ...
        <div class="page-container">
            ...
            <div class="main-content" style="text-align: center; max-width: 49%; align-items: center; justify-content: center; display: flex; margin: auto; margin-top: 301px; background: #d1d1d142; z-index: 9999999999; border-radius: 26px;">
                <form method="POST" action="{{ route('otp.verify.post') }}" autocomplete="off" style="width: 94%;">
                    @csrf


                    <!-- OTP Input -->
                    <div style="margin-top: 20px;">
                        <x-input-label for="otp" :value="__('رمز OTP')" />
                        <x-text-input id="otp" class="block mt-1 w-full" style="text-align: center; display: block; margin-top: 0.25rem; width: 100%; padding: 0.5rem; border: 1px solid #d1d5db; border-radius: 0.375rem;" type="text" name="otp" required autofocus autocomplete="off" />
                        <x-input-error :messages="$errors->get('otp')" style="margin-top: 0.5rem;" />
                    </div>
