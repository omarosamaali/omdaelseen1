...
<body style="overflow: hidden;">
    ...
    <div class="page-container">
        ...
        <div class="main-content" style="text-align: center; max-width: 49%;
                                        align-items: center;
                                        justify-content: center;
                                        display: flex;
                                        margin: auto;
            ...
            <form method="POST" action="{{ route('register') }}" autocomplete="off" style="width: 94%;">
                ...
                <div style="display: flex; gap: 20px; align-items: center; margin-top: 20px;">
                    <div style="width:50%;">
                        ...
                        <x-text-input id="name" class="block mt-1 w-full" style="text-align: center; display: block; margin-top: 0.25rem; width: 100%; padding: 0.5rem; border: 1px solid #d1d5db; border-radius: 0.375rem;" type="text" name="name" :value="old('name')" required autofocus autocomplete="name" />
                    ...
                    <div style="width:50%; position: relative;">
                        ...
                        <div class="custom-select" style="position: relative; width: 100%;">
                            ...
                            <div id="country_dropdown" style="display: block; position: absolute; top: 100%; left: 0; width: 100%; max-height: 200px; overflow-y: auto; background: white; border: 1px solid #d1d5db; border-radius: 0.375rem; z-index: 1000;">
                ...
                <div style="display: flex; gap: 20px; align-items: center; margin-top: 10px;">
                    <div style="width:50%;">
                        ...
                        <x-text-input id="phone" class="block mt-1 w-full" style="text-align: center; display: block; margin-top: 0.25rem; width: 100%; padding: 0.5rem; border: 1px solid #d1d5db; border-radius: 0.375rem;" type="text" name="phone" :value="old('phone')" required autofocus autocomplete="phone" />
                        <x-input-error :messages="$errors->get('phone')" style="margin-top: 0.5rem;" />
                    </div>
                    <!-- Email Address -->
                    <div style="width:50%;">

                        <x-input-label for="email" :value="__('البريد الالكتروني')" />
                        <x-text-input id="email" style="text-align: center; display: block; margin-top: 0.25rem; width: 100%; padding: 0.5rem; border: 1px solid #d1d5db; border-radius: 0.375rem;" class="block mt-1 w-full" type="email" name="email" :value="old('email')" required autocomplete="username" />
                ...
                <div style="display: flex; gap: 20px; align-items: center; margin-top: 10px;">
                    <div style="width:49%;">
                        ...
                        <x-text-input id="password" value="123456789" style="text-align: center; display: block; margin-top: 0.25rem; width: 100%; padding: 0.5rem; border: 1px solid #d1d5db; border-radius: 0.375rem;" class="block mt-1 w-full" type="password" name="password" required autocomplete="new-password" />
                    ...
                    <div style="width: 49%;">
                        ...
                        <x-text-input value="123456789" style="text-align: center; display: block; margin-top: 0.25rem; width: 100%; padding: 0.5rem; border: 1px solid #d1d5db; border-radius: 0.375rem;" id="password_confirmation" class="block mt-1 w-full" type="password" name="password_confirmation" required autocomplete="new-password" />
                        <x-input-error :messages="$errors->get('password_confirmation')" style="margin-top: 0.5rem;" />
                    </div>

                </div>
                <div class="flex items-start" style="direction: rtl; margin-bottom: 0px; margin-top: 10px;">
                    ...
                    <div class="mx-3 text-sm">
                        <label for="terms" class="font-light" style="color: black; font-family: cairo;">الموافقة على <a class="font-medium text-primary-600 hover:underline dark:text-primary-500" href="#">الشروط والاحكام</a></label>
                    </div>
                </div>


                <div style="display: flex; flex-direction: column-reverse; margin-top: 10px;">
                    <a style=" font-family: cairo; font-weight: 700; color: black;" class="underline text-sm text-gray-600 hover:text-gray-900 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500" href="{{ route('login') }}">
                        {{ __('بالفعل لدي حساب') }}
                    </a>

                    <x-primary-button style="text-align: center; justify-content: center; width: 100%; font-family: cairo; border:0; padding: 0.5rem 1rem; background-color: #c00000; color: white; border-radius: 0.375rem; font-weight: 500; margin-top: 10px; margin-bottom: 10px;">
                        {{ __('تسجيل') }}
                    </x-primary-button>
                </div>
            </form>
