...
@section('content')
    ...
    <body style="overflow: hidden;">
        ...
        <div class="page-container">
            ...
            <img style="z-index: 999999; position: absolute; max-width: 519px; bottom: 86px;"
                src="{{ asset('assets/img/tree.svg') }}" alt="">
            ...
            <div class="main-content"
                style="text-align: center; max-width: 49%;
                                        align-items: center;
                                        justify-content: center;
                                        display: flex;
                                        margin: auto;
                ...
                <form method="POST" action="{{ route('register') }}" autocomplete="off" style="width: 94%;">
                    ...
                    <div style="display: flex; gap: 20px; align-items: center; margin-top: 20px;">
                        <div style="width:50%;">
                            ...
                            <x-text-input id="name" class="block mt-1 w-full"
                                style="text-align: center; display: block; margin-top: 0.25rem; width: 100%; padding: 0.5rem; border: 1px solid #d1d5db; border-radius: 0.375rem;"
                        ...
                        <div style="width:50%; position: relative;">
                            ...
                            <div class="custom-select" style="position: relative; width: 100%;">
                                <input aria-autocomplete="off" autocomplete="new-country" type="text" id="country_search"
                                    name="country_search_fake"
                                    style="text-align: center; width: 100%; padding: 0.5rem; border: 1px solid #d1d5db; border-radius: 0.375rem;"
                                    placeholder="إختر الدولة" required>


                                <div id="country_dropdown"
                                    style="display: block; position: absolute; top: 100%; left: 0; width: 100%; max-height: 200px; overflow-y: auto; background: white; border: 1px solid #d1d5db; border-radius: 0.375rem; z-index: 1000;">
                                    @foreach ($countries as $code => $name)
                                        <div class="country-option" data-value="{{ $code }}"
                    ...
                    <div style="display: flex; gap: 20px; align-items: center; margin-top: 10px;">
                        ...
                        <div style="width: 49%;">
                            <x-input-label                             
 for="password_confirmation" :value="__('تاكيد كلمة المرور')" />
                            <x-text-input value="123456789"
                                style="text-align: center; display: block; margin-top: 0.25rem; width: 100%; padding: 0.5rem; border: 1px solid #d1d5db; border-radius: 0.375rem;"
                    ...
                    <div class="flex items-start" style="direction: rtl; margin-bottom: 0px; margin-top: 10px;">
                        ...
                        <div class="mx-3 text-sm">
                            <label for="terms" class="font-light" style="color: black; font-family: cairo;">الموافقة على <a
                                    class="font-medium text-primary-600 hover:underline dark:text-primary-500"
                                    href="#">الشروط والاحكام</a></label>
                        </div>
                    </div>


                    <div style="display: flex; flex-direction: column-reverse; margin-top: 10px;">
                        <a style=" font-family: cairo; font-weight: 700; color: black;"
                        ...
                        <x-primary-button
                            style="text-align: center; justify-content: center; width: 100%; font-family: cairo; border:0; padding: 0.5rem 1rem; background-color: #c00000; color: white; border-radius: 0.375rem; font-weight: 500; margin-top: 10px; margin-bottom: 10px;">
                            {{ __('تسجيل') }}
                        </x-primary-button>
                    </div>
                </form>
