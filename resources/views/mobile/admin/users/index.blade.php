...
<body>
    ...
    <div class="container min-h-dvh relative overflow-hidden py-8 dark:text-white dark:bg-black">
        <div class="relative z-10">
            <div class="relative z-10 px-6" style="position: fixed; width: 100%; width: 96%; margin: auto; background-color: white; top: 0px; padding: 10px 0px;">
                <div class="flex justify-between items-center gap-4"
                    style="visibility: hidden; flex-direction: row-reverse;">
                    ...
                    <div
                        ...
                        <div class="flex flex-col justify-center items-center pt-4">
                            <div class="relative size-24 flex justify-center items-center">
                                ...
                                @else
                                <img src="{{ asset('assets/assets/images/default.jpg') }}" alt=""
                                    class="size-[68px] rounded-full" />
                                @endif
                            ...
                            <span class="text-xs font-semibold text-color8 dark:text-white pt-4">
                                {{ $user->name }}
                            </span>
                            ...
                            <?php
                                    ...
                                    ?>
                            <span style="color: {{ $color }}; font-size: 12px; margin-bottom: 10px;">{{ $userState
                                }}</span>
