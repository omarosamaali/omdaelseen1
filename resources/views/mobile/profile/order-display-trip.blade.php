            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
                <div class="lg:col-span-1 bg-white rounded-lg shadow-md p-6 text-center">
                    ...
                    <div class="flex flex-col items-center">
                        <img src="{{ asset('storage/' . $trip?->user->avatar) }}" alt="عمدة الصين"
                            class="user-avatar mb-4">
                        <div class="info-label">اسم العميل</div>
                        <div class="info-value text-lg font-semibold">{{ $trip?->user->name }}</div>
                    </div>
                </div>
                <div class="lg:col-span-2 bg-white rounded-lg shadow-md p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <div class="info-value font-mono">{{ $trip->reference_number }}</div>
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <div class="info-value">طلب طلب</div>
                        </div>
                        <div>
                            <div class="info-label">عدد المسافرين</div>
                            <div class="info-value">{{ $trip->travelers_count }}</div>
                        </div>
                        <div>
                            <div class="info-label">تاريخ الإضافة</div>
                            <div class="info-value">{{ $trip->created_at }}</div>
                        </div>
                    </div>
                </div>
            </div>
