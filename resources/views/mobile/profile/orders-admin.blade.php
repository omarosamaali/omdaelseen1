    ...
    <div style="margin-top: 36px;">
        <div class="relative z-20 px-2">
            {{-- <div class="flex justify-between items-center gap-3 pt-6">
                <div style="border: 1px solid black;" class="flex text-black justify-start items-center gap-3 bg-color24 border border-color24 p-4 rounded-full w-full">
                    <i class="ph ph-magnifying-glass"></i>
                    <input style="color: black;" type="text" placeholder="عن ماذا تريد البحث"
            ...
            <div class="flex justify-between items-center">
                <div class="flex flex-col justify-center items-center gap-2 pt-5 font-semibold">
                    <div class="flex justify-center items-center gap-1 bg-p3 px-4 py-1.5 text-white"
                        ...
                        <p class="text-xs" style="display: flex; flex-direction: column; align-items: center; font-size: 0.65rem">منتهية
                            <span style="color: maroon;">15</span>
                        </p>
                    </div>
                    <div class="flex justify-center items-center gap-1 bg-p3 px-4 py-1.5 text-white"
                        style="color:black; border: 1px solid maroon; background-color: white; width: 100%; border-radius: 12px;">
                        <p class="text-xs" style="display: flex; flex-direction: column; align-items: center; font-size: 0.65rem">غير
            ...
            <div class="flex justify-between items-center">
                            <div class="flex flex-col justify-center items-center gap-2 pt-2 font-semibold">
                                <div class="flex justify-center items-center gap-1 bg-p3 px-4 py-1.5 text-white"
                                    style="color:black; border: 1px solid maroon; background-color: white; width: 100%; border-radius: 12px;">
                                    <p class="text-xs" style="display: flex; flex-direction: column; align-items: center; font-size: 0.65rem">
                                        منتهية
                                        <span style="color: maroon;">15</span>
                                    </p>
                                </div>
                ...
                @foreach ($products as $product)
                                <div class="bg-white dark:bg-color9 py-4 px-5 rounded-2xl shadow-md border relative"
                                    ...
                                    <div
                                        ...
                                        <a href={{ route('mobile.orders.show', $product) }} class="btns"><span><svg class="w-6 h-6 text-green-800"
                                        ...
                                        @if(Auth::user()->role == 'user')
                                        <a href="{{ route('mobile.profile.actions.user-chat', ['product_id' => $product->id]) }}" class="btns">
                                            <span><i class="fa-regular fa-envelope" style="font-size: 18px;"></i></span>
                                            مراسلة
                                        </a>
                                        @elseif(Auth::user()->role == 'admin')
                                        <a href="{{ route('mobile.profile.actions.admin-chat', ['product_id' => $product->id]) }}" class="btns">
                                            <span><i class="fa-regular fa-envelope" style="font-size: 18px;"></i></span>
                                            مراسلة
                                        </a>
                                        @endif
