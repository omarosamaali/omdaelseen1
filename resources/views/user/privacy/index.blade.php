...
<div class="container mt-5 mb-5" style="margin-right: 70px;">
    <div class="row align-items-center">
        <div class="col-md-8" style="max-width: 1200px; margin-top: 50px;">
            <div class="p-3" style=" ">
                <h3 style="color: #071739; font-weight: bold; margin-bottom: 20px; font-size: 35px;">سياسة الخصوصية</h3>
                <p style="font-size: 18px; line-height: 1.8; color: #333;">{{ $privacy->content_ar }}</p>
            </div>
        </div>
        <div class="col-md-4 text-center" style="margin-top: 50px; margin-bottom: 20px; margin-right: 316px;">
            <img src="{{ asset('storage/' . $privacy->avatar) }}" alt="About Image" class="img-fluid rounded-circle shadow" 
