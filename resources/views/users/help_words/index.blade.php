...
<div class="help-container">
    ...
    <div class="help-list">
        ...
        <div class="help-item">
            <h3 class="help-word">الكلمة بالعربي :{{ $faq->word_ar }}</h3>
            <h3 class="help-word">الكلمة بالإنجليزي :{{ $faq->word_en }}</h3>
            <h3 class="help-word" style="display: flex; align-items: center; justify-content: flex-start;">
                الكلمة بالصيني :{{ $faq->word_zh }}
                @if($faq->word_zh)
                <svg class="text-blue-600 speak-btn" data-text="{{ $faq->word_zh }}" 
                     title="تشغيل النطق" style="width: 24px; height: 24px; margin-right: 10px; cursor: pointer; color: #1e40af;"
