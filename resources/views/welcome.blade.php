...
<body style="overflow: hidden;">
    ...
    <div class="page-container">
        ...
        <div class="">
            <div>
                <img style="right: 20px; position: absolute; width: 150px;" src="{{ asset('assets/img/sgin.svg') }}" alt="">
                <div id="next-date">
            ...
            <div>
                <img style="left: 20px; position: absolute; width: 150px;" src="{{ asset('assets/img/sgin.svg') }}" alt="">
                <div id="next-date-2">
            ...
            <div class="main-content">
                ...
                <img class="arrow-image" src="{{ asset('assets/img/china-app.png') }}" alt="unkown image">
            </div> --}}
            <img class="arrow-image" src="{{ asset('assets/img/china-app.png') }}" style="    position: absolute;
    bottom: 27px;
    left: 90%;
    transform: translateX(-90%);
    height: 488px;
